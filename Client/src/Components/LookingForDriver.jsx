...
const LookingForDriver = ({ setVehicleFound, trip, fare, vehicleType }) => {
    return (
        <div>
            <div onClick={() => setVehicleFound(false)} className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50"> <BsChevronCompactDown className="text-3xl text-gray-300 cursor-pointer"/> </div>
