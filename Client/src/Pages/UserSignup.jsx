...
const UserSignup = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        setUsers({ fullname : { firstname : "", lastname : "" }, email : "", password : "" })
    }
        ...
        <div className="p-7 h-screen flex flex-col justify-between"> 
            <div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className="bg-[#111] text-white font-semibold mb-3 rounded px-4 py-2 w-full text-lg flex align-center justify-center"> Signup </button>
                </form>
                    
                <p className="text-center text-sm"> Already have an account?  <NavLink to="/login" className="text-blue-600 cursor-pointer"> Login here </NavLink> </p>
            </div> 
